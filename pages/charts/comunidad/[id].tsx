...
export default function ChartFinal(props){
    ...
    return (
        <GenChartComunidad name={props.comunidad} iniNum={props.countIni._count.id} totals={props.totalnames} labels={actionTypes} color={ORANGE} totalLocTypes={props.totalActTypes} totalComunidad={props.totalComunidad} finalArr={props.finalArr} totalGenders={props.totalGenders}/>
    );
}
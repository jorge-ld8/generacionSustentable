...
import { ORANGE, actionsA4, localidades, tipoComunidad } from "../../lib/constants";
...
export const getStaticProps: GetStaticProps = async (ctx) => {
    ...
    console.log(normalizeResults(totalGral, "nombre","nro_pob_lgbtiq", actionsA4, "_sum"));
    return {
        props:{
            totalnames: normalizeResults(totalGral, "id", "nombre", actionsA4, "_count"),
            ...
            finalArr: {
                "lgbtiq": normalizeResults(totalGral, "nro_pob_lgbtiq", "nombre", actionsA4, "_sum"),
                "mujeres": normalizeResults(totalGral, "nro_mujeres","nombre", actionsA4, "_sum"),
                "indigena": normalizeResults(totalGral, "nro_pob_ind", "nombre", actionsA4, "_sum"),
                "participantes": normalizeResults(totalGral, "nro_participantes", "nombre", actionsA4, "_sum"),
                "rural": normalizeResults(totalGral, "nro_pob_rural", "nombre", actionsA4, "_sum")
            },
            countIni
        },
        revalidate: 10,
...
export default function ChartFinal(props){
    ...
    return (
        <GenChartAction name={"A4"} iniNum={props.countIni._count.id} totals={props.totalnames} labels={actionsA4} color={ORANGE} totalLocTypes={props.totalActTypes} totalComunidad={props.totalComunidad} finalArr={props.finalArr}/>
    );
}